	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/admin/content/_server.ts.js'))
			},
			{
				id: "/api/admin/pages",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/admin/pages/_server.ts.js'))
			},
			{
				id: "/api/admin/posts",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/admin/posts/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/auth/dev-login/_server.ts.js'))
			},
			{
				id: "/api/auth/logout",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/auth/request-code/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/auth/verify-code/_server.ts.js'))
			},
			{
				id: "/pages/[slug]",
				pattern: /^\/pages\/([^/]+?)\/?$/,
